...
- **Patrick D. McCarthy's** [open-knowledge-graph](https://github.com/patdmc/open-knowledge-graph) supplies the most theoretically developed schema spine for Scale 3, with the temporal-logic rewrite this essay names. **Anthropic's** [Claude citations API](https://docs.anthropic.com/en/docs/build-with-claude/citations) ships the same triplet inside the product surface.
